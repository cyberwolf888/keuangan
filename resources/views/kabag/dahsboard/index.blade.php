...
@section('content')
    ...
    <div class="row widget-row">
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        ...
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \App\Models\Dana::whereRaw("MONTH(created_at) = ".date('m'))->count() }}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
        ...
        <div class="col-md-4">
            <!-- BEGIN WIDGET THUMB -->
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">Total Dana</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-red icon-layers"></i>
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">IDR</span>
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \DB::table('dana')->select(\DB::Raw('SUM(jumlah-sisa) as pengeluaran'))->whereRaw("MONTH(created_at) = ".date('m'))->get()[0]->pengeluaran }}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
        ...
        <div class="col-md-4">
            <!-- BEGIN WIDGET THUMB -->
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">Jumlah Kabag</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-purple icon-screen-desktop"></i>
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">Unit</span>
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \App\User::where(['type'=>1])->count() }}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
