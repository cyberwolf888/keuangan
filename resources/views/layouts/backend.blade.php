    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item @if (str_is('*.dana.*', Route::currentRouteName())) active @endif ">
                    <a href="{{ route('bendahara.dana.manage') }}" class="nav-link ">
                ...
                <li class="nav-item @if (str_is('*.user.*', Route::currentRouteName())) open active @endif ">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item @if (str_is('*.bendahara.*', Route::currentRouteName())) active @endif ">
                            <a href="{{ route('bendahara.user.bendahara.manage') }}" class="nav-link ">
                                <span class="title">Bendahara</span>
                            </a>
                        </li>
                        <li class="nav-item @if (str_is('*.kabag.*', Route::currentRouteName())) active @endif ">
                            <a href="{{ route('bendahara.user.kabag.manage') }}" class="nav-link ">
                                <span class="title">Kabag</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item @if (str_is('*.laporan.*', Route::currentRouteName())) active @endif ">
                    <a href="{{ route('bendahara.laporan.period') }}" class="nav-link ">
                        <i class="icon-docs"></i>
                ...
                <li class="nav-item @if (str_is('*.laporan.*', Route::currentRouteName())) active @endif ">
                    <a href="{{ route('kabag.laporan.period') }}" class="nav-link ">
                        <i class="icon-docs"></i>
                        <span class="title">Laporan</span>
                    </a>
                </li>
